...
var BorderImage = (function BorderImage() {
	...
	var Tool = (function Tool() {
      ...
      var borderImageWidth = border_slice.map(i => i + 'px').join(' ');
      preview.style.borderImageWidth = borderImageWidth;
      setOutputCSS('width', borderImageWidth);
      ...
      var outBorderImageCompactStyle = document.querySelector('#out-border-image-compact-style');
			CSS_code[topic].textContent = value + ';';
      outBorderImageCompactStyle.textContent = preview.style.borderImage;
		};
